...
import com.wangxinarhat.gankmvp.utils.TaskUtils;
 ...
 */
public class GirlDetailPresenter extends BasePresenter<GrilDetailView> {
    public GirlDetailPresenter(Activity context, GrilDetailView view) {
        super(context, view);
    }
